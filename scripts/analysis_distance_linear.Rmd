...
# Add tags and center them at the top of each plot
ggp_4w_pc <- ggp_4w_pc + 
  labs(tag = "A") + 
  theme(
    plot.tag.position = c(0.2, 1),
    plot.tag = element_text(face = "bold", hjust = 0.5, vjust = 1)
  )
...
# ggsave(plot = ggp_4w_3p, file.path(dir_resu, "ddr_4w_3p.png"), width = 15, height = 6, dpi = 300)
```
