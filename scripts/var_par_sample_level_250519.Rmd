...
If we run a full variation partitioning model that excludes the all observations containing any Na's (unfortunately the function does not provide any setting options like the rda), we donot get any estimation for plant ID. Also we receive a lot of warnings for coliniearity!
...
# png("/results/varpar4w.png", width = 800, height = 600)
plot(varpar4way, 
     Xnames = c('', '', '', ''),
     ...
     cutoff = 0, 
     cex = 1)
text(x = c(-2.3, -1.6, 2, 2.5), y = c(0, 1, 1, 0), 
     labels = c('Dispersal', 'Abiotic NP', 'Active Biotic NP', 'Passive Biotic NP'), 
